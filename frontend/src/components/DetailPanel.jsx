 ...
 * Displays system telemetry logs, network properties, and configuration state of a selected node.
 */
    ...
    <section className="panel detail-panel" id="detail-metadata-panel">
      ...
      <div className="panel-content">
        <div className="metadata-grid" id="telemetry-metadata-grid">
          <span className="metadata-label">System Hostname</span>
          ...
          <span className="metadata-label">Threat Severity</span>
          ...
          <span className="metadata-value" style={{ color: 'var(--color-critical)' }}>COMPROMISED</span>
        </div>

        <div style={{ marginTop: '24px', borderTop: '1px solid var(--border-color)', paddingTop: '16px' }}>
          <h3 style={{ fontSize: '0.8rem', textTransform: 'uppercase', color: 'var(--text-secondary)', marginBottom: '8px' }}>Security Diagnostic Summary</h3>
          <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', lineHeight: '1.4' }}>
            Intrusion signatures detected from multiple proxy endpoints. Port 22 is undergoing external authentication hammering. Initiating defensive connection throttle.
          </p>
        </div>
      </div>
    </section>
